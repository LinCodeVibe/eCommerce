...
const ProductScreen = () => {
	...
	return (
		<Wrap spacing='30' justify='center' midHeight='100vh'>
			{loading ? (
								...
								<Stack spacing='5'>
									<Box>
										...
										<Flex>
											<HStack spacing='2px'>
												<Star color='cyan.500' />
												<Star rating={product.rating} start={2} />
												<Star rating={product.rating} start={3} />
												<Star rating={product.rating} start={4} />
												<Star rating={product.rating} start={5} />
											</HStack>
											<Text fontSize='ml' fontWeight='bold' ml='4px'>
									...
									<Badge fontSize='lg' width='170' textAlign='center' colorScheme='gray'>
